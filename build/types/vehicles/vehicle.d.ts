...
export declare abstract class Vehicle extends THREE.Object3D implements IWorldEntity {
    ...
    interpolationPosition(vector1: THREE.Vector3, vector2: THREE.Vector3, duration: any): THREE.Vector3;
    interpolationQuaternion(quater1: THREE.Quaternion, quater2: THREE.Quaternion, duration: any): THREE.Quaternion;
